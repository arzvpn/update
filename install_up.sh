...
wget -q -O /usr/bin/menu-bot "https://raw.githubusercontent.com/arzvpn/arzxray/main/update/webmin.sh" && chmod +x /usr/bin/webmin
...
wget -q -O /usr/bin/menu "https://raw.githubusercontent.com/arzvpn/arzxray/main/update/limitspeed.sh" && chmod +x /usr/bin/limitspeed
