...
wget -q -O /usr/bin/webmin "https://raw.githubusercontent.com/arzvpn/arzxray/main/update/menu-webmin.sh" && chmod +x /usr/bin/webmin
...
wget -q -O /usr/bin/limitspeed "https://raw.githubusercontent.com/arzvpn/arzxray/main/update/mlimitspeed.sh" && chmod +x /usr/bin/limitspeed
...
wget -q -O /usr/bin/change-port "https://raw.githubusercontent.com/arzvpn/arzxray/main/update/change-port.sh" && chmod +x /usr/bin/change-port
wget -q -O /usr/bin/running "https://raw.githubusercontent.com/arzvpn/arzxray/main/update/running.sh" && chmod +x /usr/bin/running
wget -q -O /usr/bin/restart "https://raw.githubusercontent.com/arzvpn/arzxray/main/update/restart.sh" && chmod +x /usr/bin/restart
